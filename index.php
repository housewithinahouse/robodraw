...
<menu>
	<ul>
		...
		<a href="/gallery/cancer"><li id="indCtitle" onmouseover="showInd('indC')" onmouseout="hideInd('indC')">Landscapes: Itterated<div class="indicator indC" id="indCline"></div></a>
	</ul>
</menu>
<div class="highlights">
	<a href="/gallery/olo">
		<div class="box single-height single-width trigA"
			...
			<img src="/gallery/olo/images/720x720/olo002c.jpg">
		</div>
	</a>
	<a href="/gallery/langolier">
		<div class="box single-height single-width trigB"
			 onmouseover="showInd('indB')" onmouseout="hideInd('indB')">
			<img src="/gallery/langolier/images/720x720/lang004c2.jpg">
		</div>
	</a>
	<a href="/gallery/cancer">
...
<menu class="double">
	<ul>
		<li class="double rag">So, went to The Combine, was great heaps of <span>fun</span>. Can't wait for next year, hopefully there will be more people there for us to show off our drawings to.
		<br>Frankly, the most exciting part was a new idea for drawings that we tried out.</li>
		<a href="/about.html">
